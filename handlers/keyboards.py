...
def strategy_finished_kb() -> InlineKeyboardMarkup:
    """Strategiya tugagandan keyingi tugmalar."""
    builder = InlineKeyboardBuilder()
    builder.row(
        InlineKeyboardButton(text="📊 Yangi strategiya", callback_data="select_mode_strategy"),
        InlineKeyboardButton(text="📝 Jurnal rejimi",    callback_data="select_mode_journal"),
    )
    return builder.as_markup()
...
def mode_select_kb() -> InlineKeyboardMarkup:
    """
    /start da yoki strategiya tugaganda rejim tanlash.
    """
    builder = InlineKeyboardBuilder()
    builder.row(
        InlineKeyboardButton(text="📊 Strategiya bilan", callback_data="select_mode_strategy"),
        InlineKeyboardButton(text="📝 Strategiyasiz",    callback_data="select_mode_journal"),
    )
    return builder.as_markup()


def journal_mode_kb() -> InlineKeyboardMarkup:
    """Jurnal rejimida tugmalar."""
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(text="➕ Savdo kiriting", callback_data="trade_add"))
    builder.row(InlineKeyboardButton(text="🔄 Yangilash",      callback_data="refresh_journal"))
    return builder.as_markup()
